	...
	<body>
		...
		<div class="container">
			...
			<div class="center" style="margin: 78px auto; width:495px; border-style: solid; border-color: #d4af37;">
				...
				<form class="form-horizontal"  method="post" >
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="id" id="getUID" placeholder="Please Scan your Card" rows="1" cols="1" required></textarea>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="email" type="numbers" id="email" placeholder="" required>
						</div>
					</div>
          ...
          <div class="control-group">
						...
						<div class="controls">
							<input name="tname" type="text" id="tname"  placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="mobile" type="text" id="mobile"  placeholder="" required>
						</div>
					</div>
