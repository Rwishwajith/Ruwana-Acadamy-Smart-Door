...
.chiller-theme .sidebar-footer>a:last-child {
	...
	<body>
		...
		<li> <img src="sky gold LOGO 2 png.png" alt="" style="width:100px; height:50px;"></li>
			...
			<li><a href="userdetails.php">Attendance</a></li>
		</ul>

		<div class="container">
			<br>
			<div class="center" style="margin: 78px auto; width:495px; border-style: solid; border-color: #d4af37;">
				<div class="row">
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="id" id="getUID"  placeholder="Please Scan the Card" rows="1" cols="1" required></textarea>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="Grade" type="text" id="grade"  placeholder="" required>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Subject</label>
						<div class="controls">
						<select name="tute" id="tute">
								<option value="Mathematics">Mathematics</option>
								<option value="Sceince">Sceince</option>
								<option value="English ">Englsih Language</option>
								...
								<option value="Dancing Class">Dancing</option>
							</select>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input name="month" type="month" id="month"  placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="mobile" type="text" id="Fee"  placeholder="" required>
						</div>
					</div>
...
<script src="connectdf.js"></script>
</html>